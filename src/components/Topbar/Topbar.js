    ...
    return <div>
        <div class="wrapper">
                <div class="header">
                    ...
                    <span class="header-link active" href="#"><svg viewBox="-6 0 512 512" fill="currentColor">
                    ...
                    <span class="header-link" href="#"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    ...
                    <span class="header-link" href="#"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
